...
function applyConfig(config) {
  ...
  document.getElementById("clock").style.display = config.showClock ? "" : "none";
  document.getElementById("yearRow").style.display = config.showYear ? "" : "none";
  document.getElementById("monthRow").style.display = config.showMonth ? "" : "none";
  document.getElementById("weekRow").style.display = config.showWeek ? "" : "none";

  const footer = document.getElementById("footer");
  footer.style.display = config.showFooter ? "" : "none";
